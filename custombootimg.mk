MKBOOTIMG_BIN := /builds/out/host/linux-x86/bin/mkbootimg
...
$(INSTALLED_RECOVERYIMAGE_TARGET): $(MKBOOTIMG) \
	...
	(cd /builds/out/target/product/lt03wifiue/recovery/root && find * | sort | cpio -o -H newc) | gzip -9 > $(recovery_ramdisk)
